package company.com.controller.item.impl.classic;
...
import company.com.factory.domain.item.impl.beverage.beverage_Bridge.Item_BeverageFactory;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.web.bind.annotation.*;
import company.com.service.item.impl.beverage.beverage_Bridge.impl.Item_BeverageServ;
import company.com.service.item.impl.impl.ClassicService;
...
@Autowired
     ...
     * it must read from item company.com.repository to get id of an indicated branch of the item
